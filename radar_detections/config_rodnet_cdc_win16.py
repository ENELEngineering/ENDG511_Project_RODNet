dataset_cfg = dict(
    ...
    base_root="./ROD2024",              # path to directory where the dataset is downloaded from the google drive
    data_root="./ROD2024/sequences",    # path to sequence directory within the dataset folder
    anno_root="./ROD2024/annotations",  # path to annotation directory within the dataset folder
    anno_ext='.txt',
    train=dict(
        subdir='train',
...
train_cfg = dict(
    n_epoch=5,                          # number of epoch used for training
